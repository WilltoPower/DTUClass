...
**********************************************************************************/
#ifndef _DTU_101_SLAVE_A_H
#define _DTU_101_SLAVE_A_H
...
namespace DTU
{
    class D101SlaveSecond
    {
    private:
        D101SlaveSecond():_bStop(false) {
            is_101_init = false;
        }
    public:
        static D101SlaveSecond& instance() {
            static D101SlaveSecond slave;
            return slave;
        }
        ~D101SlaveSecond() { dtu101_stop_slave(); }
