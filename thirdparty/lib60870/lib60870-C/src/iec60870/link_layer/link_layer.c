...
#define SDL_GUIZHOU_ANSHUN
// static int isPLLinit = 0;

#define SDL_HAINAN_SANYA
...
#ifdef SDL_HAINAN_SANYA
        self->isPLLinit = false;
#endif
    }
...
#ifdef SDL_GUIZHOU_ANSHUN
        DEBUG_PRINT ("SLL - LINK INIT OK\n");
        self->linkLayer->isPLLinit = true;
#endif
...
#ifdef SDL_GUIZHOU_ANSHUN
    DEBUG_PRINT ("PLL - Primary state %i \n", primaryState);
#endif
...
#ifdef  SDL_HAINAN_SANYA
                // isPLLinit = 0;
                // self->linkLayer->isPLLinit = false;
#endif
            }
        }
        else {
